...
public class RequestMappingTest extends AbstractDispatcherServletTest {
	...
	// 메소드에만 선언할 경우에는 class에 빈 @RequestMapping이 있어야 함. 아니면 @Controller도 가능.
	@RequestMapping
	static class Ctrl3 {
	 ...
	 */
	/*
	 * @RequestMapping 정보는 상속된다. 단, subclass에서 @RequestMapping을 재정의하면 슈퍼클래스의 정보는
	 * 무시된다.
	 */
	@Test
	public void inheritance() throws ServletException, IOException {
		...
		// runService("/sys/super").assertViewName("subview.jsp"); // 클래스 상속과 인터페이스 구현의
		// 다른 특징! 3.0.4부터 바뀜.
